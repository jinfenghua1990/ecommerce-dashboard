...
const NAV: NavItem[] = [
  ...
  { href: "/products", label: "商品档案", phase: 2, group: true },
  { href: "/products/inventory-goods", label: "库存-正品", phase: null, nested: true },
  { href: "/products/inventory-consumables", label: "库存-耗材", phase: null, nested: true },
  { href: "/purchase/workbench", label: "采购工作台", phase: 3 },
